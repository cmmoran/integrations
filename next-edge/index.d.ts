...
declare function filterRequestHeaders(headers: IncomingHttpHeaders, forwardAdditionalHeaders?: string[]): IncomingHttpHeaders;
/**
...
declare function guessCookieDomain(url: string | undefined, options: CreateApiHandlerOptions): string;

export { CreateApiHandlerOptions, config, createApiHandler, filterRequestHeaders, guessCookieDomain };
