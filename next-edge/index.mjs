  ...
  return (req, res) => {
    ...
    return new Promise((resolve) => {
      req.pipe(request(url, {
        ...
        res2.headers["set-cookie"] = parse(res2).map((cookie) => ({
          ...cookie,
          domain,
          secure,
          encode
        })).map(({ value, name, ...options2 }) => serialize(name, value, options2));
...
export { config, createApiHandler, filterRequestHeaders, guessCookieDomain };
